...
def add_predictions(input_data):
    ...
    if prediction[0] == 0:
        ...
        st.write(
            "<span class = 'diagnosis malignant'> Malignant </span>",
    ...
    st.write(
        "This app is meant to assist professionals make a diagnosis and not meant to be a substitute for actual clinical diagnosis"
    )
...
def main():
    ...
    with st.container():
        ...
        st.write(
            "Please connect this app to your cytology lab to help diagnosis breast cancer from tissue samples. This app predicts whether a breast mass is benign or malignant using machine learning. You can also update the measurements by hand using the sliders in the side bar."
        )
